        ...
        <div id="default-carousel" className="relative w-full" data-carousel="slide">
            ...
            <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                ...
                <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                    <img src="https://source.unsplash.com/random/1200x600/?cafe"
                         className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                         alt="Cafe image from Unsplash"/>
                </div>

                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/random/1200x600/?coffee"
                         className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                         alt="Coffee image from Unsplash"/>
                </div>

                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/random/1200x600/?restaurant"
                         className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                         alt="Restaurant image from Unsplash"/>
                </div>

                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/random/1200x600/?food"
                         className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                         alt="Food image from Unsplash"/>
                </div>

                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/random/1200x600/?bali"
                         className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                         alt="Bali image from Unsplash"/>
                </div>
            </div>
